...
Pushes to [2026-1-SSHD5014-USER-CENTRED-DESIGN-IN-DIGITAL-MEDIA-Group-A01-](https://github.com/Lazaruschan/2026-1-SSHD5014-USER-CENTRED-DESIGN-IN-DIGITAL-MEDIA-Group-A01-). Sign in if Git prompts you. Then enable Pages once: **Settings → Pages → main / (root)**.
